...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run(Factory $factory)
    {
         ...
         * 登録したFactoryをofで呼び出し
         */
        $factory->of(\Infra\EloquentModel\Products::class)->time(1)->create();
        /**
         * $product_information(仮名(意味：商品情報))に連想配列で格納されたデータを、「Eloquentのcreateメソッド」でデータを挿入している。※Eloquent：データベースにデータを保存できるメソッド。
         */
        $product_information = [
            'name' => 'キウイ',
            'price' => '800',
        ...
        DB::table('products')->insert($product_information);
        $product_information = [
            'name' => 'ストロベリー',
            'price' => '1200',
        ...
        /**
         * 以下はproductsテーブルに$product_informationのデータを挿入するという命令文。
         */
        DB::table('products')->insert($product_information);
    }
}
